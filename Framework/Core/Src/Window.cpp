...
void RAVEN::Core::Window::Initialize(HINSTANCE instance, std::wstring appName, uint32_t width, uint32_t height)
{
    mInstance = instance;
...
void RAVEN::Core::Window::Terminate()
{
...
void RAVEN::Core::Window::ProcessMessage()
{
    MSG msg{};
