...
namespace CoreTest
{
	...
	public:
		...
		{
			BlockAllocator blockAllocator("OneBlockAlocator", 16, 1);
		...
		{
			BlockAllocator blockAllocator("TwoBlockAllocator", 16, 2);
		...
		{
			BlockAllocator blockAllocator("FreeBlockAllocator", 16, 1);
